...
namespace StoreFront.UI.MVC.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(Gough_StoreFrontContext context)
        {
            _context = context;
        }
        ...
        {
            var gough_StoreFrontContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,ProductId,OrderId,Quantity,ProductPrice")] OrderProduct orderProduct)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "OrderId", "City", orderProduct.OrderId);
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "Name", orderProduct.ProductId);
            return View(orderProduct);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Gough_StoreFrontContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
