...
namespace StoreFront.UI.MVC.Controllers
{
    public class StockStatusController : Controller
    {
        ...
        public StockStatusController(Gough_StoreFrontContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.StockStatuses != null ? 
                          ...
                          Problem("Entity set 'Gough_StoreFrontContext.StockStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("StockStatusId,Status")] StockStatus stockStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StockStatusId,Status")] StockStatus stockStatus)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Gough_StoreFrontContext.StockStatuses'  is null.");
            }
            var stockStatus = await _context.StockStatuses.FindAsync(id);
            if (stockStatus != null)
            {
